/* Module containing the actual API call to /rocket. Since it is in its own module, we can mock
   it in our tests. (If we were using axios or fetch, we could just mock that instead.) */
...
export const getRockets = async () => {
  new Promise(resolve => setTimeout(resolve, 500)); // Wait 0.5s for dramatic effect
